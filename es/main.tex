...
\newpage
\input{sections/intro/index}
\newpage
\input{sections/state-of-art/state-of-art}
\newpage
\input{sections/development/index}
\newpage
\input{sections/models/index}
\newpage
\input{sections/results/index}
\newpage
\input{sections/problems/index}
\newpage
\input{sections/conclusions/index}
\newpage
\input{sections/future-work/index}
\newpage
