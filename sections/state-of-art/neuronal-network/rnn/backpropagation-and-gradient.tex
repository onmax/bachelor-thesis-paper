\subsubsection{Algoritmo \textit{backpropagation} y descenso del gradiente en RNN}
...
Como se puede ver, el error cálculado $C$ a partir de todas las $c_i$, fluyen hacia atrás en el tiempo.
